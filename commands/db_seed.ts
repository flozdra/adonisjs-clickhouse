...
export default class DbSeed extends BaseCommand {
  ...
  static description = 'Execute clickhouse seeders'
   ...
   */
  @flags.string({
    description: 'Define a custom clickhouse connection for the seeders',
    alias: 'c',
  })
  ...
  private async instantiateSeeder() {
    ...
    this.seeder = new SeedsRunner(clickhouse, this.app, this.connection)
  }
  ...
  /**
   * Run as a subcommand. Never close clickhouse connection or exit
   * process here
   */
